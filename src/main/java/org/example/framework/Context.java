...
public class Context {
    ...
    public Object get(String className) throws NoSuchMethodException,
        ...
        if (annotatedConstructor.isPresent()) {
            return createAnnotationConstructor(annotatedConstructor);
        } else {
            return createDefaultConstructor(clazz);
        }
    }

    private Object createAnnotationConstructor(Optional<Constructor<?>> annotatedConstructor)
    ...
    private Object createDefaultConstructor(Class<?> clazz) throws NoSuchMethodException,
            InvocationTargetException, InstantiationException, IllegalAccessException {
